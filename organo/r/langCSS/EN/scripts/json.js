$(document).ready(function(){
	$.getJSON("http://www.organogoldmedia.com/feed/?feed=json&jsonp=?", function(data){
		$(".slide").empty();
		$.each(data, function( entryIndex, entry){
			...
			html += "<div class='header' style='position: relative; z-index: 1;'><h1 style='display:block; height: 40px; line-height: 16px; color: #9B1112; font-size: 12px;'>" + entry['title'] + "</h1></div>";
